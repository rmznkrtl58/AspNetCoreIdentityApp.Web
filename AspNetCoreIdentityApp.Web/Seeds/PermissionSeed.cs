...
namespace AspNetCoreIdentityApp.Web.Seeds
{
    public class PermissionSeed
    {
        ...
        public static async Task AddReadPermission(AppRole appRole,RoleManager<AppRole> roleManager) 
        {
            ...
            await roleManager.AddClaimAsync(appRole!, new Claim("Permission", Permissions.Permissions.Catalog.Read));

            await roleManager.AddClaimAsync(appRole!, new Claim("Permission", Permissions.Permissions.Stock.Read));
        }
        public static async Task AddUpdateAndCreatePermission(AppRole appRole, RoleManager<AppRole> roleManager)
        {
            await roleManager.AddClaimAsync(appRole!, new Claim("Permission"
             , Permissions.Permissions.Order.Create));

            await roleManager.AddClaimAsync(appRole!, new Claim("Permission", Permissions.Permissions.Catalog.Create));

            await roleManager.AddClaimAsync(appRole!, new Claim("Permission", Permissions.Permissions.Stock.Create));

            await roleManager.AddClaimAsync(appRole!, new Claim("Permission"
            , Permissions.Permissions.Order.Update));

            await roleManager.AddClaimAsync(appRole!, new Claim("Permission", Permissions.Permissions.Catalog.Update));

            await roleManager.AddClaimAsync(appRole!, new Claim("Permission", Permissions.Permissions.Stock.Update));
        }
        public static async Task AddDeletePermission(AppRole appRole, RoleManager<AppRole> roleManager)
        {
            await roleManager.AddClaimAsync(appRole!, new Claim("Permission"
            , Permissions.Permissions.Order.Delete));

            await roleManager.AddClaimAsync(appRole!, new Claim("Permission", Permissions.Permissions.Catalog.Delete));

            await roleManager.AddClaimAsync(appRole!, new Claim("Permission", Permissions.Permissions.Stock.Delete));
        }
    }
}
